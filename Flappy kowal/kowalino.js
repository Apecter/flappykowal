...
function display_intro_instructions () {
   ...
   ctx.fillText("Flappy Kowal", myCanvas.width / 2, myCanvas.height / 4);  
   }
function display_game_over () {
   ...
   ctx.fillStyle= "red";
   ctx.textAlign="center";
   ctx.fillText("Za mocna ta setunia", myCanvas.width / 2, 100);  
   ctx.fillText("Wypite setunie: " + score, myCanvas.width / 2, 150);  
   ctx.font= "20px Arial";
   ctx.fillText("Kliknij aby zrestartować", myCanvas.width / 2, 300);  
   }
...
function add_all_my_pipes() {
 ...
 pipe_piece.src = "./grafiki/rura.png" ;
function Do_a_Frame () {
 ...
 bottom_bar.src = " "
 var bird = new MySprite("./grafiki/kowalbird.png");
